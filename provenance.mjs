/**
 * Pay-per-request ERC-8004 provenance example.
 *
 * Calls https://www.liquidpad.site/api/x402/provenance/{address} with x402.
 *
 * Run:
 *   PRIVATE_KEY=0x... node provenance.mjs <address>
 */
...
if (!address || !/^0x[a-fA-F0-9]{40}$/.test(address)) {
  die("usage: node provenance.mjs <0xtokenAddress>");
}
...
const url = `${SITE}/api/x402/provenance/${address.toLowerCase()}`;
console.log(`→ GET ${url}\n`);
